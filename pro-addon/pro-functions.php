...
function bluet_kw_adv_enqueue_scripts() {
	wp_enqueue_script( 'kttg-pro-tooltip-scripts', plugins_url('assets/kttg-pro-functions.js',__FILE__), array('jquery'), false, true );
	
	//test
	//wp_enqueue_script( 'kttg-pro-findandreplacedomtext', plugins_url('assets/findandreplacedomtext.js',__FILE__), array(),"1.0.0", false );
}
